...
INSERT INTO `menu_basic_face` VALUES (19, 'MENU21100120190604194655500000', '登录日志', 'fa fa-download', '#', 'MENU21100120190604194638872000', '02', 0, '2019-06-09 22:57:56', 'sys', '2019-06-04 19:46:55', 'sys', '00');
...
INSERT INTO `menu_basic_face` VALUES (25, 'MENU21100120190607011116860000', '系统监控', 'fa fa-heartbeat', '#', 'MENU21100120190604194638872000', '02', 0, '2019-06-09 22:58:47', 'sys', '2019-06-07 01:11:16', 'sys', '00');
...
CREATE TABLE `scheduled_task_form`  (
  ...
  `DELETE_FLAG` varchar(2) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT '00' COMMENT '删除标识(00-正常 01-删除)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '定时任务主表' ROW_FORMAT = Dynamic;
...
INSERT INTO `scheduled_task_form` VALUES (10, 'TASK21100120190608003845538000', 'FORM21100120190609015220533000', '用户名', '123', '01', '2019-06-09 01:52:20', 'sys', '2019-06-09 01:52:20', 'sys', '00');
